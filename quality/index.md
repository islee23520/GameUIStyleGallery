...
| Find the authority route for uGUI or UI Toolkit. | [Game UI](../game-ui/index.md) | [Unity Game UI](../game-ui/unity/index.md) → [Unity UI Systems](../game-ui/unity/ui-systems.md) | The reader uses the Unity hub and systems guide before opening the 804-row inventory or treating a sample as authority. |
| Classify a named sample such as BagelGame. | [Unity Game UI](../game-ui/unity/index.md) | [Unity Repository Map](../game-ui/unity/repository-map.md) | The reader reaches the bounded primary-source table, labels BagelGame a version-scoped sample, and does not use stars as authority. |
| Find a safe-area or mobile lead. | [Unity Game UI](../game-ui/unity/index.md) | [Unity Organization Compressed Wiki: platform-mobile](../game-ui/unity/org-wiki.md#platform-mobile) → [Unity Repository Map](../game-ui/unity/repository-map.md#ui-adjacent-references) | The reader distinguishes the mobile cluster from the NotchSafeAreaSample relevance route, verifies on target devices, and returns to Unity architecture. |
